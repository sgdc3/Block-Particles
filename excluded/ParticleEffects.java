...
public enum ParticleEffects {
    ...
    FALLINGDUST("sweepAttack", 46, 10), // TODO: javadoc
    TOTEM("totem", 47, 11), // TODO: javadoc
    SPIT("spit", 47, 11); // TODO: javadoc
    ...
    public static final class ParticlePacket {
        ...
        public ParticlePacket(ParticleEffects effect, ParticleColor color, boolean longDistance) {
            ...
            if (effect == ParticleEffects.REDSTONE && color instanceof OrdinaryColor && ((OrdinaryColor) color).getRed() == 0) {
            ...
            try {
                ...
                if (version < 8) {
                    ...
                    if (data != null) {
                        ...
                        ReflectionUtils.setValue(packet, true, "k", effect == ParticleEffects.ITEM_CRACK ? packetData : new int[]{packetData[0] | (packetData[1] << 12)});
                    }
                }
